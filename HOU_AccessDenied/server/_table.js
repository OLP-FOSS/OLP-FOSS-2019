...
Table.prototype.makeAMove = function (x, y, turn_time) {
    var cell = _grid[y][x];
    _turns.push([_currentTurn, x, y]);
    if (cell.value == null) {
...
Table.prototype.getLastTurnTime = function () {
    return _lastTurnTime;
}

Table.prototype.getTimeToMove = function () {
    return _timeToMove;
}

Table.prototype.getTurnCount = function () {
    return _turns.length;
}

Table.prototype.saveJson = function () {
    return {
        _lastTurnTime: _lastTurnTime,
        _turns: _turns,
        _currentTurn: _currentTurn
    };
}

Table.prototype.loadJson = function (json) {
    try {
    } catch (e) {
    }
}
