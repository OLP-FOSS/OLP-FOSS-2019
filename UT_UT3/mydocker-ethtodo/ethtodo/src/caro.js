...
// 		if ( result == 1){	//check from current sq: has  the current player won?
// 			xWincount++;
// 			setResult(xWincount,oWinCount);
// 			if(xWincount == 2) {
// 				alert("Player 1 thắng rồi :((");
// 				playerNumber = 1;
// 				App.xetWin();
// 				xWinCount=0;
// 				oWinCount=0;
// 				setResult(0,0);
// 				alert("Ván đấu kết thúc rồi, Chơi lại nhé");
// 			}
// 			else{
...
var xWincount = 0;
var oWinCount= 0;
function setResult( p1, p2){
	document.getElementById("p1result").innerHTML= p1;
	document.getElementById("p2result").innerHTML= p2;
}